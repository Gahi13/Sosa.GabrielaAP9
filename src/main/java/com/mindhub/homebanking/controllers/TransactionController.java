...
public class TransactionController {
    ...
    public ResponseEntity<Object> creationTransaction(
        ...
        Account fromNumber= accountService.findByNumber(fromAccountNumber);
        Account toNumber= accountService.findByNumber(toAccountNumber);
        ...
        accountService.save(fromNumber);
        accountService.save(toNumber);
